...
bool Msg25::getLinkInfo2( char      *site                ,
	...
	//log("debug: entering getlinkinfo this=%"X INT32 "",(int32_t)this);
...
bool Msg25::doReadLoop ( ) {
	...
	//log("debug: entering doReadLoop this=%"X INT32 "",(int32_t)this);
	...
	if ( m_mode == MODE_SITELINKINFO ) {
		...
		//    "site=%s sitehash32=%"U INT32 "",site,siteHash32);
	}
	else {
	...
	*/
	...
	if ( ! m_msg5.getList ( 
				...
				m_niceness      ,
				true            )){ // error correct?
		//log("debug: msg0 blocked this=%"X INT32 "",(int32_t)this);
		return false;
	}
	// all done
	m_gettingList = false;
...
void gotListWrapper ( void *state , RdbList *list , Msg5 *msg5 ) {
	...
	//log("debug: entering gotlistwrapper this=%"X INT32 "",(int32_t)THIS);
...
bool Msg25::gotList() {
	...
	//log("debug: entering gotlist this=%"X INT32 "",(int32_t)this);
...
bool Msg25::sendRequests ( ) {
	...
	//log("debug: entering sendrequests this=%"X INT32 "",(int32_t)this);
...
bool gotLinkTextWrapper ( void *state ) { // , LinkTextReply *linkText ) {
	...
	//log("debug: entering gotlinktextwrapper this=%"X INT32 "",(int32_t)THIS);
...
bool Msg25::gotLinkText ( Msg20Request *req ) { // LinkTextReply *linkText ) {
	...
	//log("debug: entering gotlinktext this=%"X INT32 "",(int32_t)this);
