...
// skip:
	...
	if ( KEYCMP(m_endKey,m_endKeyOrig,m_ks)!=0 && m_rdbId==RDB_TFNDB && 
		...
		*m_constrainKey |= 0x02;
		// note it
		//logf(LOG_DEBUG,"oldukey.n1=%"X INT32 " n0=%" XINT64 " new.n1=%"X INT32 " n0=%" XINT64 "",
	...
	*/
	...
	// debug msg
	//log("msg3 getting list (msg5=%"U INT32 ")",m_state);
	...
	for ( int32_t i = 0 ; i < m_numFileNums ; i++ ) {
		...
		//	"startKey=n1=%"U INT32 ",n0=%" UINT64 ",  "
		//	"endKey=n1=%"U INT32 ",n0=%" UINT64 "\n",
